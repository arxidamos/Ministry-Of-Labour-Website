                ...
                <nav>
                  <ul class="nav topnav">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li class="active"><a href="eksuphrethsh_hlektronika.html">ΗΛΕΚΤΡΟΝΙΚΑ</a></li>
              ...
              <div class="row">
                <div class="span6 form-group">
                  <label class="label-control" for="amka">ΑΜΚΑ</label>
									<input type="number" name="amka" class="form-control" id="amka" placeholder="πχ. 25018202618" data-rule="minlen:11" data-rule="maxlen:11" data-msg="Τα ψηφία που εισάγατε δεν είναι 11" required />
                  <div class="validation"></div>
                </div>
								<div class="span4 form-group">
                  <label class="label-control" for="email">Ηλεκτρονική Διεύθυνση</label>
									<input type="email" class="form-control" name="email" id="email" placeholder="πχ. nikos@mail.com" data-rule="email" data-msg="Η ηλεκτρονική διεύθυνση που εισάγατε δεν είναι έγκυρη" required />
                  <div class="validation"></div>
                </div>
							</div>
							<div class="row">	
                <div class="span12 form-group">
                  <label class="label-control" for="subject">Θέμα</label>
									<input type="text" class="form-control" name="subject" id="subject" placeholder="πχ. Ασυνεπής εργοδότης" data-rule="minlen:5" data-msg="Το θέμα θα πρέπει να αποτελείται από τουλάχιστον 5 χαρακτήρες" required />
									<div class="validation"></div>
                </div>
                <div class="span12 margintop10 form-group">
                  <label class="label-control" for="message">Μήνυμα</label>
									<textarea class="form-control" name="message" rows="12" style="width:100% !important" data-msg="Παρακαλούμε δώστε μας μια σύντομη περιγραφή του ζητήματος σας" placeholder="πχ. Ο εργοδότης καθυστερεί τακτικά να καταβάλει το μισθό μου. Του έχω μιλήσει πολλές φορές, αλλά εξακολουθεί να πράττει με τον ίδιο τρόπο. Πώς θα πρέπει να κινηθώ για να διεκδικήσω τα δεδουλεύμενα μου;" required></textarea>
									<div class="validation"></div>
                  <p class="text-center">
